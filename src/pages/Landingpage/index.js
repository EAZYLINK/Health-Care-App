            ...
            <header className="w-[100%]">
              <Row className="bg-white_A700_99 items-center lg:p-[12px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[20px] w-[100%]">
                <Img
                  ...
                  alt="20220827162854"
                />
                <Text className="cursor-pointer hover:font-semibold font-semibold 3xl:ml-[107px] lg:ml-[69px] xl:ml-[79px] 2xl:ml-[89px] lg:text-[20px] xl:text-[23px] 2xl:text-[26px] 3xl:text-[32px] text-blue_600 w-[auto]">
                  Home
                </Text>
