  ...
  return (
    <>
      <Column className="bg-white_A700 font-splinesans items-center mx-[auto] lg:pb-[25px] xl:pb-[29px] 2xl:pb-[33px] 3xl:pb-[40px] w-[100%]">
        ...
        <Row className="bg-teal_51 3xl:mt-[116px] lg:mt-[75px] xl:mt-[85px] 2xl:mt-[96px] lg:p-[12px] xl:p-[14px] 2xl:p-[15px] 3xl:p-[19px] rounded-radius1962 w-[86%]">
          <Column className="lg:ml-[50px] xl:ml-[57px] 2xl:ml-[65px] 3xl:ml-[78px] lg:mt-[59px] xl:mt-[68px] 2xl:mt-[76px] 3xl:mt-[92px] w-[49%]">
            <Text className="font-medium ml-[3px] lg:text-[50px] xl:text-[58px] 2xl:text-[65px] 3xl:text-[78px] text-gray_900 w-[auto]">
              Consultancy
            </Text>
            <Text className="font-normal leading-[normal] lg:mt-[23px] xl:mt-[27px] 2xl:mt-[30px] 3xl:mt-[37px] not-italic lg:text-[31px] xl:text-[36px] 2xl:text-[40px] 3xl:text-[49px] text-gray_800 w-[93%]">
              The primary objective of a consultant is to use expert knowledge
              and skill to diagnose and treat patients while retaining ultimate
              clinical responsibility for their care. Our aim is to produce
              better and long term health outcomes with Active Patient
              Engagement.
            </Text>
          </Column>
          <Img
            src="images/img_unsplashtfjwm.png"
            className="lg:h-[318px] xl:h-[364px] 2xl:h-[409px] 3xl:h-[491px] lg:mt-[50px] xl:mt-[57px] 2xl:mt-[65px] 3xl:mt-[78px] rounded-radius981 w-[41%]"
            alt="unsplashTFJwm"
          />
        </Row>
        <Row className="items-center 2xl:mt-[110px] 3xl:mt-[132px] lg:mt-[85px] xl:mt-[97px] w-[86%]">
          <Text className="font-medium leading-[normal] 3xl:mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] lg:text-[29px] xl:text-[33px] 2xl:text-[37px] 3xl:text-[45px] text-black_900 w-[47%]">
            ...
            clinical responsibility for their care. Our aim is to produce better
            and long term health outcomes with Active Patient Engagement.
          </Text>
          <Text className="font-medium leading-[normal] 3xl:mb-[10px] lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] lg:ml-[56px] xl:ml-[64px] 2xl:ml-[72px] 3xl:ml-[87px] lg:text-[29px] xl:text-[33px] 2xl:text-[37px] 3xl:text-[45px] text-black_900 w-[47%]">
            The primary objective of a consultant is to use expert knowledge and
            skill to diagnose and treat patients while retaining ultimate
            clinical responsibility for their care. Our aim is to produce better
            and long term health outcomes with Active Patient Engagement.
